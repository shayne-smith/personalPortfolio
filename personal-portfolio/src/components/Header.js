        ...
        <div>
            <div id='header'>
                ...
                <div className='link-list'>
                    ...
                    <div id='hi'>
                        <a href='mailto:shayne.m.smith@vanderbilt.edu' rel='noopener noreferrer'>shayne.m.smith<br id='email-break'/>@vanderbilt.edu</a><img alt='yellow icon hand that waves on hover' src={require('../assets/waving.svg')}/>    
                    </div>
                </div>
            </div>
